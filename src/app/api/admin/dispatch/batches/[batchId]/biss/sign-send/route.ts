  ...
  return NextResponse.json(
    {
      ...
      suggestion: 'Dispatch documents are now signed with local mock signatures via the dispatch batch API',
      deprecatedAt: '2026-03-09',
      migrationGuide: 'See /dispatches documentation for batch signing with mock signatures'
    },
    { status: 410 } // 410 Gone
  );
}
